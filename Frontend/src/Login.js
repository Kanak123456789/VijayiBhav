...
import { MDBContainer, MDBCardImage, MDBCol, MDBRow, MDBBtn, MDBInput, MDBCheckbox } from 'mdb-react-ui-kit';
      ...
      <form onSubmit={handleSubmit}>
        <MDBRow>
          ...
          <MDBCol col='4' md='6' style={{ marginTop: "8%" }}>
            <MDBInput wrapperClass='mb-4' label='Email address' id='formControlLg' type='email' size="lg" onChange={(e) => setmail(e.target.value)} required />
